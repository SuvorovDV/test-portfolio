...
Knowledge graph is disabled. To activate:
  ...
  node C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
