...
Use template from `C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
