...
```bash
AUDITOR_MODEL=$(node "C:/Users/erkob/IdeaProjects/test-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/Users/erkob/IdeaProjects/test-portfolio/.claude/agents/gsd-eval-auditor.md for instructions.
